const EYE_OPEN = `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const EYE_SLASH = `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
function togglePwd(btn) {
  ...
  btn.innerHTML = hidden ? EYE_SLASH : EYE_OPEN;
