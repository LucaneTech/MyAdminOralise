...
from .views import (
    ...
    update_request_status, add_request_response, delete_request,
    ...
    admin_sessions_list, admin_valider_session, admin_update_statut_session,
    ...
    admin_certificate_create, admin_certificate_edit, admin_certificates_list, admin_certificate_delete,
...
urlpatterns = [
    ...
    path('requests/<int:request_id>/supprimer/', delete_request, name='delete_request'),
    ...
    path('administrateur/seances/<int:session_id>/statut/', admin_update_statut_session, name='admin_update_statut_session'),
    ...
    path('administrateur/certificats/<int:cert_id>/supprimer/', admin_certificate_delete, name='admin_certificate_delete'),
